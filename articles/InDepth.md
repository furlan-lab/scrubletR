...
Let’s read in a 10X dataset where T cells from two donors were combined
before capture. We then use souporcell to detect genetic demultiplets.
Clustering in higher dimension actually works better for visualizing the
SNP clustering… First we read in the pca-transformed probability scores
from souporcell algorithm which enables us to visualize the two expected
genotypes but having set k=3 enables 3 dimensions of data from the
algorithm (the first dimension is ‘cell size’ aka UMI count per cell).
Therefore we visualize the embedding using the 2nd and 3rd PCs, but
label the cells according to their label setting k=2. The following code
loads the 10X data, the souporcell data and makes the plot.
...
![](InDepth_files/figure-html/unnamed-chunk-2-1.png)
...
```
    ...
    ## 
    ##         0         1 Multiplet 
    ## 0.4387415 0.4950052 0.0662533

**Looks to be 6.6%.** This is what we would expect from a 10X capture of
this size.
...
![](InDepth_files/figure-html/unnamed-chunk-4-1.png)

This looks okay. The genetic multiplets have ~ 2 fold increase in
...
set a threshold and see how the percents fall out.
...
![](InDepth_files/figure-html/unnamed-chunk-5-1.png)
...
![](InDepth_files/figure-html/unnamed-chunk-6-1.png)

## Visualize

Let’s visualize, subset, and re-embed. But we need to fix subsetting in
Seurat (seurat 5 is broken)
...
![](InDepth_files/figure-html/unnamed-chunk-7-1.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-2.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-3.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-4.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-5.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-6.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-7.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-8.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-9.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-10.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-11.png)
...
![](InDepth_files/figure-html/unnamed-chunk-7-12.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-1.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-2.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-3.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-4.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-5.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-6.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-7.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-8.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-9.png)
...
![](InDepth_files/figure-html/unnamed-chunk-8-10.png)

**Much better**. We see the data is more simple and we have more readily
distinguishable clusters. \## Appendix
